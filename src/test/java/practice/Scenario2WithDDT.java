...
public class Scenario2WithDDT {
    ...
    String FirstName= w.getSheet("Orangehrm").getRow(1).getCell(2).getStringCellValue();
	String MiddleName=w.getSheet("Orangehrm").getRow(1).getCell(3).getStringCellValue();
    String LastName= w.getSheet("Orangehrm").getRow(1).getCell(4).getStringCellValue();
    String DriversLicenseNumber= w.getSheet("Orangehrm").getRow(4).getCell(2).getStringCellValue();
